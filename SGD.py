...
ap.add_argument("-e", "--epochs", type=float, default=100, metavar='', help="# of epochs")
ap.add_argument("-a", "--alpha", type=float, default=0.01, metavar='', help="learning rate")
ap.add_argument("-b", "--batch-size", type=int, default=32, metavar='', help="size of SGD mini-batches")
