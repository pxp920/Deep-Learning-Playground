...
ap.add_argument("-o", "--output", metavar="", required=True, help="path to the output loss/accuracy plot")
ap.add_argument("-e", "--epochs", metavar="", required=True, help="enter the number of epochs")
